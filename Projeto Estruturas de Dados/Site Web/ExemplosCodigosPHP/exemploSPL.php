...
<!-- Fim Navbar -->
<br>
<h1 class="text-center">Exemplo de uso da Biblioteca SPL - Estrutura Fila do tipo FIFO</h1>
<br>
<!-- Caixa de Texto -->
<div class="card text-center">
    ...
    <div class="card-body text-start" style="font-family: 'Segoe UI';">
        <p class="text-start" style="font-size: 20px;">
            <?php
                // Utilizando o método SplDoublyLinkedList com o array(fifo) push
                // Ele irá adicionar o novo valor/elemento no final da fila para depois remover no método shift e retornar o primeiro
                $fifo = new SplDoublyLinkedList();
                $fifo->push(1);
                $fifo->push(2);
                $fifo->push(3);

                // E aqui o método shift irá remover e retornar o primeiro item da lista(fila)
                while ($fifo->count()) {
                    printf("%s\n", $fifo->shift());
                }
            ?>
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalToggleLabel">Exemplo de uso da Biblioteca SPL - Estrutura Fila do tipo FIFO</h5>
        ...
        <a class="btn btn-primary" data-bs-toggle="modal" href="#exampleModalToggle" role="button">VER CÓDIGO</a>
        <!-- Fim Modal -->
    </div>

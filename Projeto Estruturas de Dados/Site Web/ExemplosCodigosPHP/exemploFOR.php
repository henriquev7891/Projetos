...
<!-- Fim Navbar -->
<br>
<h1 class="text-center">Tabuada completa do 7 - Laço FOR</h1>
<br>
<!-- Caixa de Texto -->
        ...
        <p class="text-start" style="font-size: 20px;">
            <?php
                ...
                for ($x = 0; $x <= 10; $x++) {
                    $y = 7;
                    $tabu = "$y" * "$x";
                    echo "<b style='color: red; margin-left: 20px; font-size: 30px;'>7 x $x =</b><b style='color: green; font-size: 30px;'> $tabu</b> <br>";
                }
